...
public class TiledBitmapCanvas implements CanvasLite {
        ...
        private class Version {
            ...
            public Version(int version) {
                ...
                if (this.bitmap != null) {
                    ...
                    this.canvas.setDrawFilter(new PaintFlagsDrawFilter(0, Paint.FILTER_BITMAP_FLAG));
    ...
    public TiledBitmapCanvas(int w, int h, Config config, int tileSize, int maxVersions) {
        mWidth = w;
        mHeight = h;
        mConfig = config;
        mTileSize = tileSize;
