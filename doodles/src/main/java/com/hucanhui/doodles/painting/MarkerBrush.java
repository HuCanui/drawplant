...
public class MarkerBrush extends Brush
{
  ...
  protected MarkerBrush(Context paramContext)
  {
    ...
    BlurMaskFilter localBlurMaskFilter = new BlurMaskFilter(1.0F, Blur.NORMAL);
 ...
 * Qualified Name:     com.meizu.media.painter.painting.MarkerBrush
