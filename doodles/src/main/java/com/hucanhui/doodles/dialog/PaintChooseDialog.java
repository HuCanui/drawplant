package com.hucanhui.doodles.dialog;

import java.util.List;

import com.hucanhui.doodles.R;
import com.hucanhui.doodles.R.id;
import com.hucanhui.doodles.R.layout;
import com.hucanhui.doodles.R.string;
import com.hucanhui.doodles.util.PaintInfo;
